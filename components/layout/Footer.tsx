...
import { FooterConfig } from '../../types/index';
        ...
        <div className="container mx-auto px-4 pb-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-emerald-950/50 p-4 rounded-lg border border-emerald-800">
              ...
              <div className="space-y-2 font-mono text-xs">
                  <div className="flex justify-between border-b border-emerald-800/50 pb-1"><span>Today:</span><span className="text-emerald-300">14,205</span></div>
                  <div className="flex justify-between border-b border-emerald-800/50 pb-1"><span>Yesterday:</span><span className="text-emerald-300">25,890</span></div>
                  <div className="flex justify-between border-b border-emerald-800/50 pb-1"><span>This Month:</span><span className="text-emerald-300">452,100</span></div>
                  <div className="flex justify-between pt-1"><span className="font-bold text-white">Total:</span><span className="font-bold text-emerald-300">89,120,453</span></div>
              </div>
          </div>
        </div>
